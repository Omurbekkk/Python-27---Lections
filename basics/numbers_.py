...
# Чтобы использовать, нужно его импортировать
from decimal import Decimal
a = Decimal(0.1) # мы уже передали число не точное число
...
# модуль числа   -   из отриц в полож
abs(-5) # =5
abs(10) # =10

# pow
# 1. Возводит в степень
# 2. Находит остаток от деления на 3-е число в скобках pow
